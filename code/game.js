...
function Thingy(pos)
{
  this.basePos = this.pos = pos.plus(new Vector(0.4, 0.5));
...
DOMDisplay.prototype.scrollPlayerIntoView = function() {
  ...
  // We want to keep player at least 1/3 away from side of scree
  var margin = width / 3;
...
function trackKeys(codes) {
  ...
  // That is why we needed to assign it using "Object.create()" a
